...
public class TimestampWithoutTimeZoneDataType
    ...
    public TimestampWithoutTimeZoneDataType(int precision) {
        this.name = String.format("timestamp(%d)", precision);
    }
    ...
    public GreenplumDataType getType() {
        return GreenplumDataType.TIMESTAMP_WITHOUT_TIME_ZONE;
    }

    @Override
    public String toString() {
        return "TimestampWithoutTimeZoneDataType{" +
                "name='" + name + '\'' +
                '}';
    }
}

...
public class GetGreengageRecordIT extends NifiSystemContainerizedIT {
    ...
    public void testReadRecordsFromAdbWithSupportedDataTypes() {
        ...
        assertWithPooling(() -> assertEquals(10000, postgresService.queryCountOfRowsInTable(PG_TABLE_NAME)));
    }
    ...
    public void testIncrementLoadFromAdb() {
        ...
        assertWithPooling(() -> assertEquals(20000, postgresService.queryCountOfRowsInTable(PG_TABLE_NAME)));
    }
